...
class AdvisorDetails extends React.Component {
  scrollToTop() {
    this.messagesStart.scrollIntoView(false);
  ...
  render() {
    return (
      <>
        <div
          className="advisor-mobile-wrapper"
          ref={el => {
        ...
        >
          <Router>
            <div className="mobile-info">
              <div className="mobile-info-advisor-data">
                <img
                  src={backIcon}
                  alt=""
                  className="mobile-backIcon"
                  onClick={() => this.props.history.push("/")}
                />
                <span className="mobile-advisor-name">Advisor Info</span>
              </div>
            </div>
          </Router>
          ...
          <div className="advisor-details-wrapper">
            ...
            <div className="advisor-bio">
              <div className="bio">
                <p>
                  P Anantha Raman is majorly a trader in the financial markets.
                  He makes his living by trading the NSE derivatives market. He
                  is passionate about spreading financial literacy and educating
                  clients about the, highly misunderstood, concept of risk. With
                  this approach, he became a financial planner and advisor in
                  2010.
                  <br />
                  <br /> He believes in, a goal based, data driven approach to
                  investing, as per the needs of the individual. He was
                  advising.
                  <br />
                  <br /> P Anantha Raman is majorly a trader in the financial
                  markets. He makes his living by trading the NSE derivatives
                  market. He is passionate about spreading financial literacy
                  and educating clients about the, highly misunderstood, concept
                  of risk. With this approach, he became a financial planner and
                  advisor in 2010. ...
                  <br />
...
export default withRouter(AdvisorDetails);
