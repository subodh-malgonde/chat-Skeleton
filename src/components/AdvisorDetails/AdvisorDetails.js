...
const AdvisorDetails = props => {
  return (
    <>
      <div className="advisor-mobile-wrapper">
        <Router>
          ...
          <div className="advisor-bio">
            <div className="bio">
              <p>
                ...
                passionate about spreading financial literacy and educating
                ...
                market. He is passionate about spreading financial literacy and
                educating clients about the, highly misunderstood, concept of
                risk. With this approach, he became a financial planner and
                advisor in 2010. ...
                <br />
